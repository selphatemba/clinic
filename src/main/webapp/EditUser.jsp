...
<div class="container">
    <div class="card card-container">
        <h1 class="well">Edit User Details</h1>
        <div class="col-lg-12 well">
            <div class="row">
                <form class="form-signin" id="form1" name="form1" action="/ClinicMis2/ws/user/edit" method="post" onsubmit="return checkForm(this);">
                    <div class="col-sm-12">
                        <div class="row">
